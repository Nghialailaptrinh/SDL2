...
class Dot
{
    public:
        ...
        bool movedX=1;
        bool movedY=1;
		void SetVelDot(int x,int y);
		int GetVelX(){return mVelX;}
		int GetVelY(){return mVelY;}
		void reverseVelX(){mVelX*=-1;}
		void reverseVelY(){mVelY*=-1;}
...
void Dot::SetVelDot(int x,int y){
mVelX=x;
mVelY=y;
}
	...
	else
	{
		...
		else
		{
			...
			while( !quit )
			{
                ...
                otherDot.move(wall, dot.getCollider() );

                int ReverseVelX;
                int ReverseVelY;
                if(otherDot.movedX==false) otherDot.reverseVelX();
                if(otherDot.movedY==false) otherDot.reverseVelY();
                ;
				//Clear screen
				SDL_SetRenderDrawColor( gRenderer, 0xFF, 0xFF, 0xFF, 0xFF );
